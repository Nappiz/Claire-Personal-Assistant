...
class MemoryWorkflows(ResolveProjectScope, RetrieveContext, ReadHistory, BeginTurn, CompleteTurn, PersistInteraction, OutboxSnapshots, OutboxLeases, ProcessOutboxJob, RetryDueJobs, CancelConversationJobs):
